      ...
      <div className="w-[1000px] sm:w-[80%] rounded-lg flex md:pl-10 space-x-3 md:space-x-10 p-3">
        <div className="flex flex-col items-center">
          <motion.div
            ...
            className="relative"
          >
            <p className="text-violet-400 text-[25px]">
              <MdCastForEducation />
            </p>
          ...
          <motion.div
            ...
            className=" h-full w-[3px] mt-7 rounded-md bg-gradient-to-b from-violet-400"
          ></motion.div>
        </div>
        <div className="md:w-10/12 mb-5">
          <motion.h3
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          >
            <span className="text-violet-400">Soft Skills</span>
          </motion.h3>
          <motion.p
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            ...
            viewport={{ once: false }}
            style={{ transitionDelay: "300ms" }}
            className="text-neutral-200 text-[20px] flex items-center justify-between"
          >
            This are the soft skills I have acknowledge
          </motion.p>
        </div>
      </div>
    </div>
