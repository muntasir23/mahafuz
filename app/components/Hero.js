      ...
      <div className="md:w-[900px] w-[95%]">
        ...
        <div className="md:w-[900px] w-[95%] mt-[40px]">
          <p className="md:text-[14px] text-[12px]">
            I am Mahafuz Ahamed, a skilled professional with a strong background
            in marketing and communication. Recently, I have developed a passion
            for web development and have successfully completed several
            projects. I am proficient in React and continuously strive to
            enhance my technical skills. My combined expertise in marketing,
            communication, and web development allows me to create effective and
            engaging digital solutions.
          </p>
        </div>
        <div className="mt-[20px]">
          <ShinnyButton text="Get Started" />
        </div>
      </div>
    </div>
  );
